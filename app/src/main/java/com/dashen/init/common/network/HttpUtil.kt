//package com.dashen.init.common.newNetwork
//
//import com.dashen.init.DemeterApp
...
//import com.dashen.init.common.utils.NetUtils
...
//        setSubscriber(observable, object : Subscriber<ResultBean<T>>() {
...
//                        if (NetUtils.getNetWorkState(DemeterApp.context) == NetUtils.NETWORK_NONE) { //网络连接
//                            "网络不给力，请检查网络连接"
//                        } else {  //服务器异常
//                            "服务器连接异常，请稍后重试"
//                        }
...
//
//    //订阅事件
//    private fun <T> setSubscriber(observable: Observable<ResultBean<T>>, subscriber: Subscriber<ResultBean<T>>) {
