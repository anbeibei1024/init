...
//    var mApp: DemeterApp? = null
//    protected var activity: BaseActivity? = null
//
//
//    override fun onCreate(savedInstanceState: Bundle?) {
//        super.onCreate(savedInstanceState)
//        mApp = getActivity()!!.application as DemeterApp
...
//        super.onDestroy()
//        DemeterApp.refWatcher!!.watch(this)
//    }
//
...
//            AppSettingsDialog.Builder(this, details)
//                    .setTitle(getString(R.string.permission_title))
//                    .setPositiveButton(getString(R.string.permission_setting))
//                    .setNegativeButton(getString(R.string.permission_cancle), null)
//                    .build()
//                    .show()
//        }
//    }
